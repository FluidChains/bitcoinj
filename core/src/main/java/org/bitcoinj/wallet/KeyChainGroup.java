...
public class KeyChainGroup implements KeyBag {
     ...
     * provided.
     */
    public KeyChainGroup(NetworkParameters params, DeterministicSeed seed, ImmutableList<ChildNumber> accountPath, String chainCode) {
        this(params, null, ImmutableList.of(new DeterministicKeyChain(seed, accountPath, chainCode)), null, null);
    }
