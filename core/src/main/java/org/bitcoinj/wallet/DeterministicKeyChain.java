...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public static class Builder<T extends Builder<T>> {
        ...
        public T watch(DeterministicKey accountKey, ImmutableList<ChildNumber> accountPath) {
            checkState(this.accountPath == null, "either watch or accountPath");
    ...
    public DeterministicKeyChain(DeterministicKey key, Script.ScriptType outputScriptType, HDPath accountPath) {
        basicKeyChain = new BasicKeyChain();
        this.seed = null;
        this.rootKey = null;
        basicKeyChain.importKey(key);
