...
public interface TransactionConfidenceEventListener {
     ...
     * </ol><p>
     *
     * <p>To find if the transaction is dead, you can use tx.getConfidence().getConfidenceType() ==
     * TransactionConfidence.ConfidenceType.DEAD. If it is, you should notify the user
